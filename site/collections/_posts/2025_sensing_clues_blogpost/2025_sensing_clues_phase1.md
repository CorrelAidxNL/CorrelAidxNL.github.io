...
tags:
  ...
  - R
  - shiny
image: 2025_sensing_clues_logo.jpeg
---
...
<figure>
    <img src="2025_sensing_clues_world_map.png" alt="world map" style="float:left; width:250px; margin-right:40px;" />
</figure>
...
* Open Source [Copernicus Satellite Landcoverage data](https://dataspace.copernicus.eu/) that allows the division of areas into farmland, water, forest area, and inhabited land. This data is updated annually.
...
<img src="2025_sensing_clues_yoy.png" alt="Annual NDVI January of the Conservation area in Zambia from 2021 - 2024. White spots represent missing data due to cloud coverage." style=" width:600px;" />
...
<img src="2025_sensing_clues_time_series.png" alt="NDVI time series over a 12 month period of the conservation area in Zambia using data from  2019 - 2024. The highlighted area around the line represents the normal range." style=" width:600px;" />
...
<img src="2025_sensing_clues_heatmap_landcover_2.png" style=" width:600px;" />


### The Shiny app

<figure>
    <img src="2025_sensing_clues_shinyapp.png" alt="world map" style="float:left; width:400px; margin-right:40px;" />
</figure>
